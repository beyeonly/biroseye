...
export default function App() {
  // v1.0.107: EAS Update — σιωπηλός έλεγχος στο άνοιγμα· αν υπάρχει νέα έκδοση
  // JS, κατεβαίνει και εφαρμόζεται αμέσως (reload). Ποτέ σε dev mode.
  useEffect(() => {
    (async () => {
      if (__DEV__) return;
      try {
      ...
      } catch (e) { /* offline ή server μη διαθέσιμος — συνεχίζουμε κανονικά */ }
    })();
  }, []);
